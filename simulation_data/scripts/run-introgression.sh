...
# run_introgression_cases_difficult () {
#   OUTPUT_DIR=../simulated_events/single_event/introgression-difficult/
#   mkdir -p ${OUTPUT_DIR}
...
# export -f run_introgression_cases_difficult

# seq 1 50 | xargs -I{} -P ${NUM_THREADS} -t bash -c "run_introgression_cases_difficult {}"

run_introgression_cases_controlled () {
  OUTPUT_DIR=../simulated_events/single_event/introgression-controlled/
  mkdir -p ${OUTPUT_DIR}
...
export -f run_introgression_cases_controlled

seq 1 50 | xargs -I{} -P ${NUM_THREADS} -t bash -c "run_introgression_cases_controlled {}"
